...
protocol AnyAuthenticationColors {
    var white: Color { get }
...
struct AuthenticationColors: AnyAuthenticationColors, AnyInjectable  {
    static func register(_ container: AppContainer) {
        container.register(type: (any AnyAuthenticationColors).self) { resolver in
            AuthenticationColors()
        }
    }
