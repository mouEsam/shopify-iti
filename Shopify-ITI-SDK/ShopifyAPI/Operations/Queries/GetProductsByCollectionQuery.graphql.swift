...
public extension ShopifyAPI {
  class GetProductsByCollectionQuery: GraphQLQuery {
    public static let operationName: String = "getProductsByCollection"
    public static let document: Apollo.DocumentType = .notPersisted(
      definition: .init(
        #"""
        query getProductsByCollection($cursor: String, $count: Int!, $collectionId: ID!, $productType: String, $productVendor: String, $productTag: String, $country: CountryCode, $lang: LanguageCode) @inContext(country: $country, language: $lang) {
          collection(id: $collectionId) {
            __typename
            products(
              first: $count
              after: $cursor
              filters: [{productType: $productType}, {productVendor: $productVendor}, {available: true}, {tag: $productTag}]
            ) {
              __typename
              edges {
                __typename
    ...
    public var productTag: GraphQLNullable<String>
    ...
    public init(
      ...
      count: Int,
      collectionId: ID,
      productType: GraphQLNullable<String>,
      productVendor: GraphQLNullable<String>,
      productTag: GraphQLNullable<String>,
    ...
    public struct Data: ShopifyAPI.SelectionSet {
      ...
      public static var __selections: [Apollo.Selection] { [
        .field("collection", Collection?.self, arguments: ["id": .variable("collectionId")]),
      ] }
      ...
      public struct Collection: ShopifyAPI.SelectionSet {
        ...
        public static var __selections: [Apollo.Selection] { [
          ...
          .field("products", Products.self, arguments: [
            ...
            "filters": [["productType": .variable("productType")], ["productVendor": .variable("productVendor")], ["available": true], ["tag": .variable("productTag")]]
          ]),
        ] }
        ...
        public struct Products: ShopifyAPI.SelectionSet {
          ...
          public struct Edge: ShopifyAPI.SelectionSet {
            ...
            public struct Node: ShopifyAPI.SelectionSet {
              ...
              /// Collection.Products.Edge.Node.FeaturedImage
              ///
              /// Parent Type: `Image`
